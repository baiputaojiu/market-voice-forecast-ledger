...
- `docs/superpowers/specs/2026-08-29-pc-transfer-handoff-design.md`: 承認済みPC移行境界と受入条件。
- `docs/superpowers/plans/2026-08-29-pc-transfer-handoff.md`: PC移行Tasks 1～12の詳細計画。
- `scripts/pc-transfer/pc-transfer.py`: export/verify/import/rebuild-runtime/verify-runtimeのoperator入口。
- `tests/backend/e2e/test_pc_transfer_round_trip.py`: 合成data/runtime/operator stateを使う完全round-trip検証。
