...
EXPECTED_TRIGGERS = (
    ...
    "speaker_threshold_configs_limited_update",
    "speaker_threshold_configs_no_delete",
    ...
    "videos_no_delete",
    "videos_no_replace",
    "voice_reference_calibrations_no_delete",
    "voice_reference_calibrations_no_replace",
    "voice_reference_calibrations_no_update",
